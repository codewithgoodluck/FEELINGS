...
export const ACHIEVEMENTS = [
  ...
  { id: 'streak_14',   emoji: '⚡', label: 'Fortnight',      desc: '14-day check-in streak' },
  { id: 'streak_30',   emoji: '🌙', label: 'Monthly',        desc: '30-day check-in streak' },
...
export function recordCheckInAchievements(streakCount) {
  ...
  if (streakCount >= 14 && unlock('streak_14')) newly.push('streak_14')
  if (streakCount >= 30 && unlock('streak_30')) newly.push('streak_30')
  return newly
}
